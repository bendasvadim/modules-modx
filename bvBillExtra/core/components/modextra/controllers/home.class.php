...
class modExtraHomeManagerController extends modExtraManagerController
{
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->modExtra->config['jsUrl'] . 'mgr/widgets/userbalance.grid.js');
        $this->addJavascript($this->modExtra->config['jsUrl'] . 'mgr/widgets/userbalance.windows.js');

        $this->addJavascript($this->modExtra->config['jsUrl'] . 'mgr/widgets/usertransaction.grid.js');
        $this->addJavascript($this->modExtra->config['jsUrl'] . 'mgr/widgets/usertransaction.windows.js');

        $this->addJavascript($this->modExtra->config['jsUrl'] . 'mgr/widgets/usertransactionstatus.grid.js');
        $this->addJavascript($this->modExtra->config['jsUrl'] . 'mgr/widgets/usertransactionstatus.windows.js');
