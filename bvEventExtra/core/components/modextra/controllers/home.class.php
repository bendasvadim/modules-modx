...
class modExtraHomeManagerController extends modExtraManagerController
{
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->modExtra->config['jsUrl'] . 'mgr/widgets/notifications.grid.js');
        $this->addJavascript($this->modExtra->config['jsUrl'] . 'mgr/widgets/notifications.windows.js');
